...
const HomePage: React.FC = () => {
  ...
  return (
    ...
    <main className="flex-1">
        ...
        <section className="abslute py-12 px-4 md:px-6 bg-white z-50"> {/* Adjusted background */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        <Card key={index} className="overflow-hidden service-card rounded-xl "> {/* Added service-card class for GSAP */}
                            ...
                            <CardContent className="p-4 text-left m-3 rounded-md bg-gray-100 hover:bg-green-700  hover:text-white cursor-pointer">
                                <h3 className="text-xl font-bold mb-2 text-gray-800">{service.title}</h3> 
                                <p className="text-gray-600 text-md">{service.description}</p>
                                <CardFooter className="p-4 pt-0 text-left">
                                    <Button variant="outline" className="text-green-800 border-green-800 hover:bg-green-50 rounded-full"> {/* Adjusted colors and style */}
                                        Learn More
                                    </Button>
                                </CardFooter>
                            </CardContent>
